...
final case class TypeLambda(
    ...
    def clearParameters: TypeLambda = copy(parameters = _root_.scala.None)
    def withParameters(__v: dotty.tools.dotc.semanticdb.Scope): TypeLambda = copy(parameters = Option(__v))
