...
object Build {
  ...
  */
  ...
  val semanticdbScalaPBVersion = "0.11.17"
  val semanticdbProtocVersion = "3.25.5"

  def semanticdbCodegenSettings: Seq[Setting[_]] = Seq(
    PB.additionalDependencies := Nil,
    libraryDependencies ++= Seq(
      ("com.thesamet.scalapb" %% "scalapb-runtime" % semanticdbScalaPBVersion % "protobuf").cross(CrossVersion.for3Use2_13),
      ("com.thesamet.scalapb" %% "scalapb-runtime" % semanticdbScalaPBVersion).cross(CrossVersion.for3Use2_13),
    ),
    Compile / PB.protocVersion := s"com.google.protobuf:protoc:$semanticdbProtocVersion",
